...
const LoginForm: React.FC = () => {
  ...
  return (
    <section
      className={`LoginBG1 min-h-screen  flex items-center justify-center ${
    ...
    >
      <Container maxWidth="xl" className="p-0 m-0">
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Join the future by filling some information !!!
              </Typography>
           ...
           onSubmit={formiklogin.handleSubmit}
                ...
                {activeTab === "By Email" ? (
                  <>
                    ...
                    <TextField
                      ...
                      placeholder="Email"
                      className="!mt-0"
                      sx={{marginBottom:formiklogin.errors.email?"0px":"24px",}}
                      InputProps={{
                        startAdornment: (
                    ...
                    {!showOTPField && (
                      <React.Fragment>
                        ...
                        <TextField
                          ...
                          className="!mt-0"
                          sx={{marginBottom:formiklogin.errors.password?"0px":"24px",}}
                          InputProps={{
                            startAdornment: (
                              <InputAdornment position="start">
                                <IconButton edge="start"  
            ...
            <TextField
              ...
              placeholder="Phone"
              className="!mt-0"
              sx={{marginBottom:formiklogin.errors.phone?"0px":"24px",}}
              InputProps={{
              startAdornment: (
            <InputAdornment position="start">
             <IconButton edge="start"   
        ...
        InputLabelProps={{ className: "text-gray-400" }}
      />
                   {formiklogin.touched.phone && formiklogin.errors.phone && (
                      <Typography color={"error"} variant="caption">
                        {formiklogin.errors.phone}
                      </Typography>
                    )}
                ...
                {!showOTPField && (
                  ...
                  >
                {formiklogin.isSubmitting ? "Loading..." : "Login"}
